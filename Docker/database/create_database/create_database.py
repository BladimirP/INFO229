...
def insert_data(cursor):
	...
	('El Oporto tumba al Benfica', '2020-12-31', 'https://as.com/futbol/2021/12/30/internacional/1640841807_994671.html', 'Diario web', 'Deporte'),
	('Quinto Retiro AFP', '2021-12-30', 'https://chile.as.com/chile/2021/12/30/actualidad/1640860616_372550.html', 'Diario web', 'Economia'),
	('Resiliencia al Covid', '2021-12-29', 'https://www.df.cl/noticias/economia-y-politica/pais/resiliencia-al-covid-cual-es-la-razon-del-exito-de-chile/2021-12-29/163053.html', 'Diario', 'Salud');
	''')
    cursor.execute("COMMIT;") 
